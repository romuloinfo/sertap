        ...
        ?>
            <div class="col-md-10">
              <div class="alert alert-warning" role="alert">
                Cuidado ao excluir uma Cidade, se ela estiver cadastrada em algum imóvel pode causar inconsistência na Busca dos imóveis.
              </div>
              <h4 class="lead bg-titulo">Deseja excluir a Cidade "<strong><?php print $nome_cidade ?></strong>"?</h4>
            </div>
            <div class="col-md-10">
              <form action="" method="GET" class="form-row justify-content-center">
                ...
                <div class="form-group col-6 col-lg-4">
                  <a href="cadastro-cidade.php" class="btn btn-success btn-block" > Não </a>
                </div>
              </form>
            </div>
        <?php }
        ...
        <div class="form-group col-md-10">
            <?php
              ...
              if ( isset($_GET['id_excluir']) ){
                ...
                $sql = "DELETE FROM cidades WHERE id = $id_excluir";

                if ($query = $conexao->query($sql) ){
                  print '<div class="alert alert-success alert-dismissible fade show" role="alert">
                            Cidade EXCLUÍDA! <a href="cadastro-cidade.php" class="alert-link"> Voltar para Gerenciar Bairros.</a>
                   ...
                   print '<div class="alert alert-warning alert-dismissible fade show" role="alert">
                            Falha ao tentar Excluir a Cidade, tente novamente mais tarde.
                            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                              <span aria-hidden="true">&times;</span>
                            </button>
                          </div>';
