    ...
    <div class="row justify-content-center">
        ...
        ?>
            <div class="col-md-10">
              ...
              <h4 class="lead bg-titulo">Deseja excluir o usuário "<strong><?php print $nome_usuario ?></strong>"?</h4>
            ...
            <div class="col-md-10">
              <form action="" method="GET" class="form-row justify-content-center">
                ...
                <div class="form-group col-6 col-lg-4">
                  <a href="cadastro-usuario.php" class="btn btn-success btn-block" > Não </a>
                </div>
              </form>
            </div>
        <?php }
              ...
              if ( isset($_GET['id_excluir']) ){
                ...
                if ($query = $conexao->query($sql) ){
                  print '<div class="alert alert-success alert-dismissible fade show" role="alert">
                            Usuário EXCLUÍDO! <a href="cadastro-usuario.php" class="alert-link"> Voltar para Gerenciar USUÁRIOS.</a>
