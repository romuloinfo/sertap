    ...
    <div class="row justify-content-center">
        ...
        ?>
            <div class="col-md-10">
              ...
              <h4 class="lead bg-titulo">Deseja excluir o cliente "<strong><?php print $nome_cliente ?></strong>"?</h4>
            ...
            <div class="col-md-10">
              <form action="" method="GET" class="form-row justify-content-center">
                ...
                <div class="form-group col-6 col-lg-4">
                  <a href="cadastro-cliente.php" class="btn btn-success btn-block" > Não </a>
                </div>
              </form>
            </div>
        <?php }
        ...
        <div class="form-group col-md-10">
            <?php
              ...
              if ( isset($_GET['id_excluir']) ){
                ...
                $sql = "DELETE FROM clientes WHERE id = $id_excluir";

                if ($query = $conexao->query($sql) ){
                  print '<div class="alert alert-success alert-dismissible fade show" role="alert">
                            Cliente EXCLUÍDO! <a href="cadastro-cliente.php" class="alert-link"> Voltar para Gerenciar Clientes.</a>
                  ...
                  print '<div class="alert alert-warning" role="alert">
                          Falha ao excluir o cliente, favor tentar novamente.
                        </div>';
                }
              }
