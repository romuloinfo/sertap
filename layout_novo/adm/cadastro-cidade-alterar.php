  ...
  <div class="container">
    ...
    <div class="row justify-content-center">
      <?php
        ...
        ?>
        <div class="col-md-10">
          <h4 class="lead bg-titulo">Deseja alterar o nome desta Cidade?</h4>
        </div>
        <div class="col-md-10">
            <form action="" method="GET" class="form-row justify-content-center">
              <div class="form-group col-md-8">
                <!-- <label for="inputPassword4">Senha</label> -->
                <input type="text" class="form-control" id="nome_cidade_alterar" name="nome_cidade_alterar" value="<?php if (isset($_GET['nome_cidade'])) print $nome_cidade; ?>"
              ...
              <div class="form-group col-md-8">
                <a href="cadastro-cidade.php" class="btn btn-outline-success btn-block">Cancelar</a>
              </div>
            </form>
        </div>
        <?php } ?>
        <div class="col-md-10">
          <?php
            if ( isset($_GET['nome_cidade_alterar']) ){
              $nome_cidade = $_GET['nome_cidade_alterar'];
              $id_alterar = $_GET['id_alterar'];

              include "../includes/conexao.php";
              $sql = " UPDATE cidades SET descricao='$nome_cidade' WHERE (id='$id_alterar')";

              if ($query = $conexao->query($sql) ){
                print '<div class="alert alert-success alert-dismissible fade show" role="alert">
                          Cidade ALTERADA com Sucesso! <a href="cadastro-cidade.php" class="alert-link"> Voltar para Tela GERENCIAR CIDADES.</a>
